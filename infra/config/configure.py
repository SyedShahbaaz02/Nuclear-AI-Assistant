...
AI_SEARCH_DATASOURCES_RELATIVE_PATH = 'aisearch/datasources'
AI_SEARCH_INDEXES_RELATIVE_PATH = 'aisearch/indexes'
AI_SEARCH_INDEXERS_RELATIVE_PATH = 'aisearch/indexers'
AI_SEARCH_SKILLSETS_RELATIVE_PATH = 'aisearch/skillsets'
